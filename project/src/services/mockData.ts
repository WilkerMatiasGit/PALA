...
export const mockAprovacoes: AprovacaoGet[] = [
  { id: 1, actividade_id: 1, actividade_nome: 'Aula Química Orgânica I', aprovador_id: 4, aprovador_nome: 'Maria Santos', etapa: 'dlab', decisao: 'aprovado', comentario: 'Proposta adequada, laboratório disponível.', decidido_em: '2026-05-28T10:00:00Z', criado_em: '2026-05-28T10:00:00Z', actualizado_em: '2026-05-28T10:00:00Z' },
  { id: 2, actividade_id: 1, actividade_nome: 'Aula Química Orgânica I', aprovador_id: 5, aprovador_nome: 'Rui Fernandes', etapa: 'supervisor', decisao: 'aprovado', comentario: 'Aprovado. Técnico atribuído.', decidido_em: '2026-05-29T10:00:00Z', criado_em: '2026-05-29T10:00:00Z', actualizado_em: '2026-05-29T10:00:00Z' },
  { id: 3, actividade_id: 5, actividade_nome: 'Aula Física Aplicada', aprovador_id: 4, aprovador_nome: 'Maria Santos', etapa: 'dlab', decisao: 'aprovado', comentario: 'Sem problemas.', decidido_em: '2026-05-26T10:00:00Z', criado_em: '2026-05-26T10:00:00Z', actualizado_em: '2026-05-26T10:00:00Z' },
  { id: 4, actividade_id: 6, actividade_nome: 'Aula Química Analítica', aprovador_id: 4, aprovador_nome: 'Maria Santos', etapa: 'dlab', decisao: 'rejeitado', comentario: 'Choque de horário com outra atividade já aprovada.', decidido_em: '2026-05-20T10:00:00Z', criado_em: '2026-05-20T10:00:00Z', actualizado_em: '2026-05-20T10:00:00Z' },
];
